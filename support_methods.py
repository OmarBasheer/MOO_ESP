...
def price_calculate(min, price, ps_per_min, ps_min, price_per_min):  # change price to power consumption
    sum_cost = price_per_min[min] * price
    ps_per_min.append(price)
    ps_min.append(min)
